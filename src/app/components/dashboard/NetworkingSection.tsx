...
export default function NetworkingSection({ user }: NetworkingSectionProps) {
  ...
  const contacts = user?.contacts || [
    ...
    },
    {
      ...
      notes: 'Discussed potential collaboration on ML project. Need to follow up with proposal.'
    }
  ];
        ...
        <div className="p-6">
          {filteredContacts.length > 0 ? (
                ...
                >
                  <div className="relative h-20 bg-gradient-to-r from-primary/30 to-primary-dark/30">
                    ...
                    <div className="absolute top-4 right-4">
                      <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${getStatusColor(contact.status)} text-white`}>
                  ...
                  <div className="pt-12 px-4 pb-4">
                    ...
                    <p className="text-sm text-gray-400 line-clamp-1">{contact.position} at {contact.company}</p>
                    
                    {contact.last_contact && (
                      <p className="text-xs text-gray-500 mt-2">
                        Last contacted: {new Date(contact.last_contact).toLocaleDateString('en-US', { 
                          year: 'numeric', 
                          month: 'short', 
                          day: 'numeric'
                        })}
            ...
            >
              ...
              <p className="mt-1 text-sm text-gray-400">No contacts match your current filter.</p>
              <div className="mt-6">
            ...
            >
              ...
              <div className="p-6">
                <div className="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    <h4 className="text-lg font-medium">{contactDetails.name}</h4>
                    <p className="text-sm text-gray-400">{contactDetails.position} at {contactDetails.company}</p>
                    <span className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium mt-1 ${getStatusColor(contactDetails.status)} text-white`}>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={`mailto:${contactDetails.email}`} className="text-sm text-primary hover:underline truncate">
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <a href={contactDetails.linkedin} target="_blank" rel="noopener noreferrer" className="text-sm text-primary hover:underline truncate">
                      {contactDetails.linkedin.replace('https://linkedin.com/in/', '')}
                    </a>
                  </div>
                </div>

...
export default function InterviewsSection({ user }: InterviewsSectionProps) {
  ...
  const mockInterviews = user?.interviews || [
    ...
    },
    {
      ...
      status: "completed",
      feedback:
        "Good knowledge of CI/CD pipelines. Could improve on Kubernetes concepts.",
      score: 7.2,
      interviewer: "AI Assistant",
      duration: 50,
      questions: [
          ...
          {mockInterviews.length > 0 ? (
                  ...
                  <div className="px-6 py-4">
                    ...
                    {interview.status === "completed" && (
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">
                          Score:{" "}
                          <span className={getScoreClass(interview.score)}>
                            {interview.score}
                          </span>
                          /10
                        </span>
            ...
            <motion.div variants={fadeIn} className="text-center py-10">
              ...
              <p className="mt-1 text-sm text-gray-400">
                Schedule your first mock interview to practice for your next
                job.
              </p>
              <div className="mt-6">
                <Link href="/interview-dashboard">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>
                        {selectedInterview.interviewer || "AI Assistant"}
                      </span>
                    </div>
                  </div>
                      ...
                      <div className="mt-2">
                        <div className="flex items-center space-x-2">
                          ...
                          <span>
                            Score:{" "}
                            <span
                              className={getScoreClass(selectedInterview.score)}
                            >

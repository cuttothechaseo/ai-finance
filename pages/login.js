    ...
    <div className="min-h-screen bg-[#0F0F2D] bg-gradient-to-b from-[#0F0F2D] to-[#151538] flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <p className="mt-2 text-center text-sm text-[#A3A3A3]">
          ...
          <Link href="/signup" className="font-medium text-[#6C63FF] hover:text-[#8A7FFF] transition-colors duration-200">
            Sign up
          </Link>
        </p>
      </div>
              ...
              <div className="flex items-center justify-between mt-3">
                <div className="flex items-center">
                  <input
                    ...
                    name="remember_me"
                    type="checkbox"
                    className="h-4 w-4 text-[#6C63FF] focus:ring-[#6C63FF]/50 border-[#3A3A5A] rounded bg-[#1E1E3F]"
                  />
                  <label htmlFor="remember_me" className="ml-2 block text-sm text-[#A3A3A3]">
                    Remember me
                  </label>
                </div>

                <div className="text-sm">
                  <a href="#" className="font-medium text-[#6C63FF] hover:text-[#8A7FFF] transition-colors duration-200">
